                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 mb-3 mb-sm-0">
                                                    <input type="text" class="form-control form-control-user" name="name" id="exampleFirstName"
                                                        placeholder="Name" value="{{ $user->name}}" required autofocus autocomplete="name">
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="user" method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
                                        @csrf
                                        @method('put')

                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="password" class="form-control form-control-user" name="current_password" id="exampleFirstName"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input type="password" class="form-control form-control-user" name="password_confirmation" id="exampleFirstName"
